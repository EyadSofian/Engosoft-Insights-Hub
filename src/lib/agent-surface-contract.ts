...
export const SURFACE_CONTRACTS: readonly SurfaceContract[] = [
  ...
  },
  {
    ...
    views: [
      ...
      { id: "campaigns", title: t("الحملات", "Campaigns") },
      { id: "adsets", title: t("مجموعات الإعلانات", "Ad sets") },
      { id: "ads", title: t("الإعلانات", "Ads") },
      { id: "creatives", title: t("المواد الإعلانية", "Creatives") },
      { id: "assets", title: t("الأصول", "Assets") },
      { id: "forms", title: t("نماذج العملاء", "Lead forms") },
      { id: "landing", title: t("صفحات الهبوط", "Landing pages") },
      { id: "quality", title: t("جودة العملاء", "Lead quality") },
      { id: "sales", title: t("نتائج المبيعات", "Sales outcomes") },
    ],
    ...
    sources: [
      ...
      },
      {
        ...
        summaryPaths: ["coverage", "matches", "totals", "exactTotals", "funnel", "refresh"],
      },
    ],
    rows: [
      {
