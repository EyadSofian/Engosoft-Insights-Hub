...
export const METRICS: Record<MetricKey, MetricDef> = {
  ...
  platformLeads: {
    ...
    group: "advertising",
    ar: {
      label: "العملاء المحتملين من المنصات (Platform Leads)",
      short: "عملاء المنصات",
      formula: "مجموع الليدز اللي المنصة نفسها بلّغت عنها",
      what: "عدد الليدز زي ما المنصة الإعلانية عدّتها — مش عدد أودو.",
      how: "من ميتا: استمارات الليدز على فيسبوك (Leads on Facebook). من سناب: الليدز الأصلية (Leads Native). الرقمين بيتجمعوا زي ما هما.",
      source: "تبويبات الإعلانات في المنصات، مش الـCRM.",
      dateBasis: "تاريخ الإعلان.",
      whenEmpty:
        "شرطة لو المنصة مبتبلّغش عن ليدز خالص. الرقم ده هو مقام تكلفة العميل المحتمل (CPL).",
    },
    en: {
      label: "Platform leads",
      short: "Platform leads",
      formula: "Sum of leads the ad platform itself reported",
      what: "The lead count as the ad platform counted it — not the Odoo count.",
      how: "Meta contributes on-Facebook lead-form submissions; Snapchat contributes native leads. The two are summed as reported.",
      source: "Platform ad tabs, not the CRM.",
      dateBasis: "Ad date.",
      whenEmpty:
        "A dash when the platform reports no lead metric at all. This is the CPL denominator.",
    },
  },
  ...
  cpl: {
    ...
    ar: {
      ...
      short: "تكلفة العميل",
      formula: "الإنفاق ÷ عملاء المنصات",
      what: "بتدفع كام عشان تجيب ليد واحد من الإعلانات.",
      how: "إجمالي الإنفاق مقسوم على الليدز اللي المنصة بلّغت عنها — مش ليدز أودو.",
    ...
    en: {
      ...
      short: "CPL",
      formula: "Spend ÷ Platform leads",
      what: "What one advertising lead costs.",
      how: "Total ad spend divided by the leads the platform reported — not the Odoo lead count.",
  ...
  won: {
    ...
    group: "crm",
    ar: {
      label: "الصفقات المكسوبة (Won)",
      short: "صفقات مكسوبة",
      formula: "عدد الليدز اللي حالتها Won",
      what: "عدد العملاء اللي قفلوا فعلاً واشتروا.",
      how: "عدّ ليدز الـCRM اللي التعريف الحالي بيعتبرها مكسوبة.",
      source: "CRM Leads في أودو.",
      dateBasis:
        "الفلترة بتاريخ إنشاء الليد — يعني الليدز اللي اتفتحت في الفترة وكسبت، مش اللي قفلت في الفترة.",
    ...
    en: {
      ...
      how: "Counts CRM leads the current definition treats as won.",
      source: "CRM Leads in Odoo.",
      dateBasis:
        "Filtered by lead creation date — leads opened in the window that went on to win, not deals closed in the window.",
  ...
  lost: {
    ...
    ar: {
      ...
      how: "من تبويب Lost Analysis بس. مرحلة Lost جوه CRM Leads مش بتتحسب هنا خالص.",
      source: "Lost Analysis — الأرشيف المعتمد.",
      dateBasis: CRM_WINDOW_AR,
    ...
    en: {
      ...
      how: "From the Lost Analysis tab only. CRM stage text never increments this counter.",
      source: "Lost Analysis — the authoritative archive.",
      dateBasis: CRM_WINDOW_EN,
  ...
  conversionRate: {
    ...
    ar: {
      ...
      short: "نسبة الإغلاق",
      formula: "الصفقات المكسوبة ÷ إجمالي العملاء النظيف × ١٠٠",
      what: "من كل ١٠٠ ليد، كام واحد اشترى.",
      how: "البسط: عدد Won. المقام: إجمالي العملاء النظيف = ليدز الـCRM + صفوف تحليل الخسائر.",
    ...
    en: {
      ...
      how: "Numerator: Won count. Denominator: clean lead total = CRM leads + Lost Analysis rows.",
  ...
  cpa: {
    ...
    ar: {
      ...
      short: "تكلفة الصفقة",
      formula: "الإنفاق ÷ الصفقات المكسوبة",
      what: "بتدفع كام إعلانات عشان تقفل صفقة واحدة.",
      how: "إجمالي الإنفاق مقسوم على عدد Won. الأساس الافتراضي هو الصفقات المكسوبة؛ فيه أساس بديل بعدد الفواتير بيتغيّر من الفلاتر.",
      ...
      whenEmpty: "شرطة لو مفيش صفقات مكسوبة، أو لو المنصة ملهاش إنفاق مسجّل.",
    },
    en: {
