...
export const DICT = {
  ...
  acquisition_performance: { ar: "تحليل أداء الاستحواذ", en: "Acquisition performance" },
  ...
  price_book: { ar: "دليل الأسعار", en: "Price book" },
  ...
  // price book
  price_book_sub: {
    ar: "أسعار الدورات المنشورة، ومراقبة الالتزام بها في الفواتير المدفوعة",
  ...
  pb_search_placeholder: {
    ar: "ابحث باسم الدورة أو الكود…",
    en: "Search by course name or code…",
  },
  pb_specialization: { ar: "التخصص", en: "Specialization" },
  pb_subcategory: { ar: "القسم", en: "Section" },
  pb_delivery: { ar: "نوع الدورة", en: "Delivery" },
  pb_payment_method: { ar: "طريقة الدفع", en: "Payment method" },
  pb_currency: { ar: "العملة", en: "Currency" },
  pb_country: { ar: "الدولة", en: "Country" },
  pb_live_offers: { ar: "العروض السارية فقط", en: "Live offers only" },
  pb_official_price: { ar: "السعر الرسمي", en: "List price" },
  pb_min: { ar: "الحد الأدنى", en: "Floor" },
  pb_max: { ar: "الحد الأقصى", en: "Ceiling" },
  pb_offer: { ar: "عرض", en: "Offer" },
  pb_bundle: { ar: "باقة", en: "Package" },
  pb_level: { ar: "باقة مستوى", en: "Level package" },
  pb_incentive: { ar: "حافز موظف", en: "Staff incentive" },
  pb_on_hold: { ar: "موقوف — ممنوع البيع", en: "On hold — do not sell" },
  pb_needs_review: { ar: "يحتاج مراجعة", en: "Needs review" },
  pb_no_book: {
    ar: "لم تُنشر أي قائمة أسعار بعد. استورد الملف من تبويب الإدارة ثم اضغط نشر.",
    en: "No price book is published yet. Import the workbook from the Manage tab, then publish it.",
  },
  pb_code: { ar: "كود المنتج", en: "Product code" },
  pb_odoo_code: { ar: "كود أودو", en: "Odoo product" },
  pb_not_linked: { ar: "غير مربوط بأودو", en: "Not linked to Odoo" },
  pb_valid_until: { ar: "ينتهي في", en: "Ends" },
  pb_coverage: { ar: "نسبة التغطية", en: "Match coverage" },
  pb_compliance_rate: { ar: "نسبة الالتزام", en: "Compliance rate" },
  pb_below_min: { ar: "بيع تحت الحد الأدنى", en: "Sold below floor" },
  pb_leakage: { ar: "الفارق عن الحد الأدنى المنشور", en: "Gap to the published floor" },
  pb_leakage_note: {
    ar: "فرق تراكمي عن الحد الأدنى المنشور، وليس خسارة محاسبية مؤكدة.",
    en: "Cumulative shortfall against the published floor, not a confirmed accounting loss.",
  },
  pb_unmatched: { ar: "بدون مطابقة منتج", en: "Unmatched product" },
  pb_unknown_payment: { ar: "طريقة دفع غير معروفة", en: "Unknown payment method" },
  pb_audited_lines: { ar: "بنود تم تحليلها", en: "Lines audited" },
  pb_needs_review_lines: { ar: "تحتاج مراجعة", en: "Needs review" },
  pb_recalculate: { ar: "إعادة التحليل", en: "Re-run audit" },
  pb_recalculating: { ar: "جارٍ التحليل…", en: "Auditing…" },
  pb_publish: { ar: "نشر", en: "Publish" },
  pb_rollback: { ar: "رجوع لهذه النسخة", en: "Roll back to this" },
  pb_import: { ar: "استيراد قائمة أسعار", en: "Import a price list" },
  pb_change_log: { ar: "سجل التعديلات", en: "Change log" },
  pb_draft: { ar: "مسودة", en: "Draft" },
  pb_published: { ar: "منشورة", en: "Published" },
  pb_archived: { ar: "مؤرشفة", en: "Archived" },
  pb_last_audit: { ar: "آخر تحليل", en: "Last audit" },
  pb_never_audited: { ar: "لم يُشغّل التحليل بعد", en: "The audit has not run yet" },
  ...
  website_filter_note: {
    ar: "اختيار «من / إلى» يفلتر الليدز بتاريخ الإنشاء، والمبيعات بتاريخ الدفع عند توفره وإلا تاريخ المصدر أو الأوردر، وحملات web أو con بتاريخ صرف الإعلان.",
    en: "The From / To selector filters leads by creation date, website sales by payment date when available (otherwise source/order date), and web or con campaigns by ad-spend date.",
  },
